  ...
  return (
    <footer class="relative">
        ...
        <div class="absolute right-64 bottom-64">
            ...
            <ul class="flex mt-6">
                <li><img src="images/icons/white_behance.png" alt="Behance" width="30" height="30" class="mr-5"/></li>
                <li><img src="images/icons/white_linkedin.png" alt="LinkedIn" width="30" height="30" class="mr-5"/></li>
                <li><img src="images/icons/white_instagram.png" alt="Instagram" width="30" height="30"/></li>
            </ul>
        </div>
    </footer>
  );
