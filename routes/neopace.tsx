            ...
            <main class="flex flex-col justify-center items-center mt-12 md:mt-32">
                ...
                <div class="text-center">
                    <span class="text-left inline-block mx-6 md:w-1/3">
                        <h2 class="mt-6 text-xl mx-6 md:text-5xl mb-3 md:mb-6">Rebranding d'un Label de musique dans l'Électro Chill : </h2>
                ...
                <img src="/images/projects/neopace/disc.png" alt="" width="35%" class="relative hidden right-0 top-0"/>
            </main>
            <Footer></Footer>
        </>
    );
